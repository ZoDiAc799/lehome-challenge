...
def get_policy_class(name: str) -> type[PreTrainedPolicy]:
    ...
    if name == "tdmpc":
        ...
        from lerobot.policies.act_jepa.modeling_act_jepa import ACTJEPAPolicy

        return ACTJEPAPolicy
    elif name == "vqbet":
...
def make_policy_config(policy_type: str, **kwargs) -> PreTrainedConfig:
    ...
    elif policy_type == "act_jepa":
        return ACTJEPAConfig(**kwargs)
...
def make_pre_post_processors(
    ...
    **kwargs: Unpack[ProcessorConfigKwargs],
    ...
    elif isinstance(policy_cfg, ACTJEPAConfig):
        from lerobot.policies.act_jepa.processor_act_jepa import make_act_jepa_pre_post_processors

        processors = make_act_jepa_pre_post_processors(
            config=policy_cfg,
            dataset_stats=kwargs.get("dataset_stats"),
        )
